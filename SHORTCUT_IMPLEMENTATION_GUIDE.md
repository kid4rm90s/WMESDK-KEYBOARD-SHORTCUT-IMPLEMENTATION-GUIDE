...
**Canonical reference:** [`WME-Shortcut-Demo.user.js`]([WME-Shortcut-Demo.user.js](https://github.com/kid4rm90s/WMESDK-PERSISTENT-KEYBOARD-SHORTCUT-GUIDE/raw/refs/heads/master/WME-Shortcut-Demo.user.js)) — a fully working script demonstrating all 4 patterns below. Use it as a copy-paste library.
